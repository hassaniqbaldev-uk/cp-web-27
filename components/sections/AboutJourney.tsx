    ...
    <>
      ...
      >
        ...
        >
          ...
          <MarqueeDrag>
            {/* Two identical copies, so travelling half the track's length
                lands the second where the first began and the loop never
                seams. */}
            <ul className="animate-marquee-up max-425:animate-marquee-left max-425:w-max max-425:flex-row max-425:[animation-play-state:var(--play,running)] flex flex-col group-hover:[animation-play-state:paused] motion-reduce:animate-none">
