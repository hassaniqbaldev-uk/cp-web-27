    ...
    <>
      ...
      >
        ...
        >
          ...
          <ul className="animate-marquee-up max-425:animate-marquee-left max-425:w-max max-425:flex-row flex flex-col group-hover:[animation-play-state:paused] motion-reduce:animate-none">
